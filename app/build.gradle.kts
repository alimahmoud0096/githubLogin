...
android {
    ...
    // For Kotlin 2.0.0+, Compose Compiler is configured via the plugin
    // No need for composeOptions block
...
dependencies {
    ...
    kspAndroidTest("com.google.dagger:hilt-android-compiler:2.88")
